...
- Generative UI
- Claude Cowork 插件生态
- **Skills/Plugins 标准化**（新增）

### GitHub 持续追踪项目
- openclaw — 个人 AI 助手标杆（注意：安全危机中）
- claude-mem — AI 记忆插件（27K 星，现象级）
- Personal_AI_Infrastructure — AI 基础设施框架
...
- **KeygraphHQ/shannon** — AI 安全审计工具（21K 星，爆发级）（新增）
- **github/gh-aw** — GitHub 官方 Agentic Workflows（新增）
- **openai/skills** — Codex 技能目录（新增）
- **tobi/qmd** — 本地知识搜索引擎（新增）
- **badlogic/pi-mono** — 全栈 Agent 工具包（新增）
...
- **Andrej Karpathy**（agentic engineering 概念推动者）（新增）

#### 中国
- 阿里通义千问团队（千问 App + 原生 Agent + Qwen 3.5 即将发布）
- 百度千帆团队（文心助手 vs 微信）
- 快手可灵 AI 团队
- 字节豆包团队（日活破亿，Seedance 2.0）
- **智谱团队**（GLM-5 发布）（新增）
- **DeepSeek 团队**（V4 即将发布）（新增）
